...
public class JSONObject : Nullable
{
    ...
    private void ParseAsString(string str)
    {
        if (str != null)
        {
                            ...
                            if (depth == 0 && !openquote)
                            {
                                ...
                                if (str[i] == ']' || str[i] == '}')
                                {
                                    if (str.Length == 2)
                                    {
                                        /*
                                        if (str[i] == ']')
                                            list.Add(new JSONObject(JSONObject.Type.ARRAY));
                                        else
                                            list.Add(new JSONObject(JSONObject.Type.OBJECT));
                                        */
                                    }
                                    else
                                    {
  ...
  */
    ...
    public void LoadLocal(string fileName)
    {
        ...
        {
            ParseAsString(saveFile.ReadToEnd());
        }
    }
